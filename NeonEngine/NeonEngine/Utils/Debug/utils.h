...
namespace Neon { namespace Debug {
	struct Utils {
		static void print_vector_vec3(const std::vector<glm::vec3> &v) {
		...
		static void print_vector_vec2(const std::vector<glm::vec2> &v) {
		...
		static void print_vector_uint(const std::vector<GLuint> &v) {
		...
		static double calcFPS(GLFWwindow *window, double theTimeInterval = 1.0, std::string theWindowTitle = "NONE")
		{
